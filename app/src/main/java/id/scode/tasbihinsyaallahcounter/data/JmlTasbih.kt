package id.scode.tasbihinsyaallahcounter.data
 ...
 * Created on 03 4/3/20 2:41 PM 2020
 * id.scode.tasbihinsyaallahcounter.data
 ...
 */
@Parcelize
data class JmlTasbih(val jml: String?) : Parcelable